...
export const CreateGroupReducer = (createGroupState = initialState.createGroup, action) => {
    switch (action.type) {
        case 'SET_CREATE_GROUP_USERS':
            return Object.assign({}, createGroupState, {
                users: action.users
            });
        default:
...
export const GroupsReducer = (groupState = initialState.groups, action) => {
